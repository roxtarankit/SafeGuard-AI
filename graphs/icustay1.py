...
class IcuStay:
    ...
    def frequencyAnalysis(self):
        ...
        i = 1
        categorical_cols = ['FIRST_CAREUNIT', 'LAST_CAREUNIT', 'FIRST_WARDID', 'LAST_WARDID', 'AGE', 'GENDER']
        plt.figure(figsize=(10, 6))
        sns.set_style("darkgrid")
        plt.grid(True)  
    ...
    def dropMissingData(self):
        ...
        self.df = self.df.dropna(subset=['FIRST_CAREUNIT', 'LAST_CAREUNIT', 'FIRST_WARDID', 'LAST_WARDID', 'AGE', 'GENDER' ])
    ...
    def createBinaryTarget(self):
        ...
        self.df['stay_over_days'] = (self.df['LOS'] > 1).astype(int)
    ...
    def featureSelection(self):
        # Select features
        features = ['FIRST_CAREUNIT', 'LAST_CAREUNIT', 'FIRST_WARDID', 'LAST_WARDID', 'AGE', 'GENDER']
    ...
    def predictIcuStay(self):
        ...
        # Step 5: Output
        print("Prediction (0 = ICU stay <= 15 days, 1 = > 15 days):", prediction[0])
# End of class
